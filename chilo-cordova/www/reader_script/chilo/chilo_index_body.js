...
var text1 = "<div class=\"returnarea\" id=\"returnbook\" style=\"display:none\">"
          ...
          + "<img src=\"reader_script/chilo/backtochilobook.png\" alt=\"Back to CHiLO Book\"/>"
          + "</a>"
          + "</div>"
          ;
...
var text2 = "<div id=\"layer_board_area\">"
          ...
          + "<span><img class=\"sousa\" src='reader_script/chilo/sousa.png' /></span>"
          + "<p class=\"btn_close\"><img src=\"reader_script/chilo/btn_close.png\"  /></a></p>"
          + "</div></div>"
          ;
