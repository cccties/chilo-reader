...
//        return parentEngine.client.onNavigationAttempt(url);
	...
	boolean ret = parentEngine.client.onNavigationAttempt(url);
    ...
    public void onReceivedHttpAuthRequest(WebView view, HttpAuthHandler handler, String host, String realm) {
	    ...
	    Log.d(TAG, "onReceivedHttpAuthRequest proceed: " + host + "," + realm);
            return;
        }
	    ...
	    Log.d(TAG, "onReceivedHttpAuthRequest plugin: " + host + "," + realm);
            return;
        }

        // By default handle 401 like we'd normally do!
        Log.d(TAG, "onReceivedHttpAuthRequest 401: " + host + "," + realm);
